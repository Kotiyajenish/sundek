...
/**
 * Template Name: product cat one
 */
get_header();
$product_category_banner_image = get_field('product_category_banner_image');
?>
<!-- breadcrumb area -->
<div class="breadcrumb-area breadcrumb-padding bg-img" style="background-image:url(<?php echo $product_category_banner_image['url'];?>)">
    <div class="container">
...
<div class="section section-padding">
    <div class="container">
        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb-n6">
            <?php
            $category_slug = 'category_one'; // Replace 'your-category-slug' with the actual category slug
